...
const CALLABLES = Object.freeze({
  ...
  createProductionReview: 'createProductionReview',
  deactivateBagianMaster: 'deactivateBagianMaster',
  ...
  getBagianMaster: 'getBagianMaster',
  ...
  seedBagianMaster: 'seedBagianMaster',
...
export function createApiAdapter(options = {}) {
  ...
  return Object.freeze({
    ...
    createProductionReview: (request) => call(CALLABLES.createProductionReview, request),
    deactivateBagianMaster: (request) => call(CALLABLES.deactivateBagianMaster, request),
    ...
    getBagianMaster: (request = {}) => call(CALLABLES.getBagianMaster, request),
    ...
    seedBagianMaster: (request = {}) => call(CALLABLES.seedBagianMaster, request),
