...
- Backend GAS modular untuk health check, sheet bootstrap, spreadsheet admin toolbar dengan project links, auth/session, RBAC, validation, audit, production logs, quarantine, daily closing, adjustment, recap, dashboard, access gate, Script Properties maintenance, dan native test runner.
