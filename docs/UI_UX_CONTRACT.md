...
- Pilihan mode nav seperti `Menu Operator` atau `Pilih Role / Workspace` harus memakai elemen nyata di dalam `.app-nav`, bukan hanya pseudo-element `::before`, agar tetap accessible.
