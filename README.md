...
- View Pengaturan dibuka dari top floating button dan menyediakan Try Role instan untuk demo/trial saat `AUTH_MODE=OFF`, sehingga tester tidak perlu berganti email.
